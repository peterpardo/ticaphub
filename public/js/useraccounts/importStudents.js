...
//     // Validate if user picked a school and specialization
//     let validatedSchool =  inputinputValidation(schoolContainer.value);
//     let validatedSpecialization =  inputinputValidation(specializationContainer.value);
//     if (!validatedSchool) {

//     } else if (!validatedSpecialization) {
