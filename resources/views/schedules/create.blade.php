    ...
    <form 
        ...
        <div class="w-1/2 mx-auto rounded shadow px-4 py-3 mt-2">
            ...
            <div>
                ...
                <input type="text" name="name" class="text-gray-800 w-full rounded resize-none" value="{{ old('name') }}">
                @error('name')
            ...
            <div class="flex mt-2 w-full">
                <div class="mr-2 flex-1">
                    ...
                    <input name="start_date" type="date" class="text-gray-800 rounded w-full" value="{{ old('start_date') }}">
                    @error('start_date')
                ...
                <div class="flex-1">
                    ...
                    <input name="end_date" type="date" class="text-gray-800 rounded w-full" value="{{ old('end_date') }}">
                    @error('end_date')
                    <span class="inline-block bg-red-500 w-full rounded px-2 py-1 text-white my-1">{{ $message }}</span>
                    @enderror
                </div>
