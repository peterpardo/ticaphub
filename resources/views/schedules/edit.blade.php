    ...
    <form 
        ...
        <div class="w-1/2 mx-auto rounded shadow px-4 py-3 mt-2">
            ...
            <div>
                ...
                <input type="text" name="name" class="w-full rounded resize-none" value="{{ $sched->name}}">
                @error('name')
            ...
            <div class="flex mt-2 w-full">
                <div class="mr-2 flex-1">
                    ...
                    <input name="start_date" type="date" class="rounded w-full" value="{{ $sched->start_date }}">
                    @error('start_date')
                ...
                <div class="flex-1">
                    ...
                    <input name="end_date" type="date" class="rounded w-full" value="{{ $sched->end_date }}">
                    @error('end_date')
                    <span class="inline-block bg-red-500 w-full rounded px-2 py-1 text-white my-1">{{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="mt-2">
                ...
                <div class="mr-2 inline-block">
                    <input type="checkbox" class="mr-1" id="panelists" name="attendees[]" value="panelists"><label for="panelists">panelists</label>
                </div>
                <div class="mr-2 inline-block">
                    <input type="checkbox" class="mr-1" id="students" name="attendees[]" value="students"><label for="students">students</label>
                </div>
                <div class="mr-2 inline-block">
                    <input type="checkbox" class="mr-1" id="officers" name="attendees[]" value="officers"><label for="officers">officers</label>
                </div>
            </div>
