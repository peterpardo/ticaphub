    ...
    <div class="certificate">
        <div class="certificate-body">
            ...
            <div class="student-name">
                <h1>{{ $panelist->first_name . ' ' . $panelist->middle_name . ' ' . $panelist->last_name }}</h1>
            </div>
            <div class="about-certificate">
                <p>
                    {{-- for his/her participation in the FEU Tech's (TICAP NAME) --}}
                </p>
            </div>
            <div class="award-name">
                <p>
                    for participating in the FEU Tech's ({{ $ticap->name }})
                </p>
            </div>
