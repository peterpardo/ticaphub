<x-app-layout>
    ...
    <div class="flex justify-between my-4">
        <a href="{{ route('add.brand') }}" class="inline-block md:w-32 bg-green-600 dark:bg-green-100 text-white dark:text-white-800 font-bold py-3 px-6 rounded-lg mt-4 hover:bg-green-500 dark:hover:bg-green-200">+ Image</a>
    </div>
