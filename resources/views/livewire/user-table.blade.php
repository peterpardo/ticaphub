    ...
    <div class="hidden min-w-screen h-screen animated fadeIn faster fixed left-0 top-0 justify-center items-center inset-0 z-50 outline-none focus:outline-none" id="resetFormModal">
        ...
        <div class="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
            ...
            <div >
                ...
                <!--footer-->
                <div class="p-3 mt-2 text-center space-x-4" wire:loading.remove>
                ...
                {{-- Spinner --}}
                <div class="flex justify-center items-center p-3 mt-2 space-x-4" wire:loading.flex wire:target="resetUsers">
                    <div class="
                        spinner-border
                        animate-spin
                        inline-block
                    ...
                    <p>Ending the current TICaP. Please Wait.</p>
                </div>
            </div>
        </div>
    </div>
