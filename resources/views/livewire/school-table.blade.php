<div>
    ...
    <div class="flex justify-between my-5">
        ...
        <button wire:click="openConfirmationModal" class="font-bold rounded shadow px-5 py-2 text-white bg-green-500 hover:bg-green-600">
            START TICAP
        </button>
    </div>
    ...
    {{-- Alert Message --}}
    @if(session('status'))
        <div class="bg-{{ session('status') }}-100 border-l-4 border-{{ session('status') }}-500 text-{{ session('status') }}-700 p-4 mb-2" role="alert">
