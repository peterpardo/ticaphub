<div>
    ...
    <div class="flex justify-between">
        <form wire:submit.prevent='addPosition' class='mb-5'>
            <div class="mb-2">
                <input type="text" wire:model='newPosition' class="text-gray-800 rounded"
        ...
        <div>
            <a class="inline-block font-bold bg-blue-500 hover:bg-blue-600 px-5 py-3 text-white rounded"
                href="{{ route('set-candidates') }}">Proceed to Candidates</a>
        </div>
    </div>
                    ...
                    @foreach ($positions as $position)
                        <tr class="text-gray-700">
                            ...
                            <td class="px-4 py-3 text-md border">
                                @if ($position->id == 1)
                                    <span class="bg-gray-300 rounded px-2 py-1 cursor-default shadow">Can't be edited</span>
                                @else
                                    <button wire:click="selectPosition({{ $position->id }}, 'update')"
                                        class="rounded shadow px-2 py-1 my-0.5 text-white bg-blue-500 hover:bg-blue-600">Edit</button>
                                    <button wire:click="selectPosition({{ $position->id }}, 'delete')"
                                        class="rounded shadow px-2 py-1 my-0.5 text-white bg-red-500 hover:bg-red-600">Delete</button>
                                @endif
                            </td>
                        </tr>
                    @endforeach
        ...
        <div class="w-full  max-w-lg p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white ">
            ...
            <div>
                ...
                <div class="p-3 mt-2 text-center space-x-4 md:block">
                    ...
                    <button wire:click="deletePosition"
