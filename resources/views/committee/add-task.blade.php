<x-app-layout :scripts="$scripts">
    ...
    <form
        ...
        <div class="w-1/3 bg-white   mx-auto shadow rounded px-3 py-3 text-gray-800">
            <div id="message"></div>
            <div class="my-3">
                <label class="block">Task Title</label>
                <input type="text" name="title" id="title" class="rounded w-full text-gray-800">
            </div>
            <div class="my-3">
                <label class="block">Task Description</label>
                <textarea type="text" name="description" id="description" class="rounded w-full text-gray-800 resize-none"></textarea>
            </div>
            <div class="my-3 relative">
                ...
                <div class="relative">
                  ...
                  <input type="text" name="member" id="member" autocomplete="off" class="rounded w-full text-gray-800" placeholder="Search officer">
