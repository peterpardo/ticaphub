    ...
    <div class="w-1/2 mx-auto">
        ...
        <form 
            ...
            <div class="mb-2">
                ...
                <input type="text" name="first_name" value="{{ old('first_name') }}"  class="border rounded-lg px-auto py-2 mt-5">
            </div>
            ...
            <div class="mb-2">
                ...
                <input type="text" name="middle_name" value="{{ old('middle_name') }}"  class="border rounded-lg px-auto py-2 mt-5">
            </div>
            ...
            <div class="mb-2">
                ...
                <input type="text" name="last_name" value="{{ old('last_name') }}"  class="border rounded-lg px-auto py-2 mt-5">
            </div>
