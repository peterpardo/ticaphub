                ...
                <table class="w-full table-fixed text-center">
                    <thead>
                        <tr
                            ...
                            <td class="px-2 py-1 font-semibold text-lg border">Group</td>
                            <td class="px-2 py-1 font-semibold text-lg border">School</td>
                            <td class="px-2 py-1 font-semibold text-lg border">Specialization</td>
                            <td class="px-2 py-1 font-semibold text-lg border">Actions</td>
                        </tr>
                    </thead>
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-2 py-1 border flex justify-center">
                                    <a href="/users/groups/{{ $group->id }}"
                                        class="flex items-center px-2 py-1 rounded bg-blue-500 hover:bg-blue-600 text-white">
