                ...
                @foreach($groups as $group)
                    <tr>
                        ...
                        <td class="px-2 py-1 border flex justify-center">
                            <a href="/users/groups/{{ $group->id }}" class="flex items-center mx-1 px-2 py-1 rounded bg-yellow-500 hover:bg-yellow-600 text-white">
                            ...
                            <a href="/users/groups/{{ $group->id }}/edit" class="flex items-center mx-1 px-2 py-1 rounded bg-blue-500 hover:bg-blue-600 text-white">
